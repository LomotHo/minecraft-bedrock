...
this documentation is for image lomot/minecraft-bedrock:1.11.2.1-r1, lomot/minecraft-bedrock:1.11.2.1-debian-r1
...
docker run -d --restart=always -it --name mcpe \
  -v /opt/mcpe-data:/data \
  -p 12345:19132/udp lomot/minecraft-bedrock:1.11.2.1-r1
```
