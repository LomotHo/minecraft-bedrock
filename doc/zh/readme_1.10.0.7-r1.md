...
当前服务器核心版本: 1.10.0.7 镜像版本: lomot/minecraft-bedrock:1.10.0.7-r1
...
3. 部署服务器
	...
	```bash
	docker run -d -it --name mcpe -v /opt/mcpe-data:/data -p 19132:19132/udp lomot/minecraft-bedrock:1.10.0.7-r2
	```
...
```bash
docker run -d -it --name mcpe -v /opt/mcpe-data:/data --net=host lomot/minecraft-bedrock:1.10.0.7-r2
```
