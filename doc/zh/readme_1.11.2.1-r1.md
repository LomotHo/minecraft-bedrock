...
当前服务器核心版本: 1.11.2.1 镜像版本: lomot/minecraft-bedrock:1.11.2.1-r1, lomot/minecraft-bedrock:1.11.2.1-debian-r1
...
docker run -d --restart=always -it --name mcpe \
  ...
  -p 19132:19132/udp lomot/minecraft-bedrock:1.11.2.1-r1
```
...
```bash
docker run -d -it --name mcpe -v /opt/mcpe-data:/data --net=host lomot/minecraft-bedrock:1.11.2.1-r1
```
...
lomot/minecraft-bedrock   1.11.2.1-debian-r1   8cd07241f9b3        2 weeks ago         191MB
