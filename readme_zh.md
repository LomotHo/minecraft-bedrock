...
当前服务器核心版本: 1.11.0.23 镜像版本: lomot/minecraft-bedrock:1.11.0.23-r1, lomot/minecraft-bedrock:1.11.0.23-debian-r1
...
3. 部署服务器
	...
	```bash
	docker run -d --restart=on-failure:5 -it --name mcpe -v /opt/mcpe-data:/data -p 19132:19132/udp lomot/minecraft-bedrock:1.11.0.23-r1
	```
